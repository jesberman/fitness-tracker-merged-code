      ...
      <div>
        <Navbar fluid>
          <Navbar.Header>
            ...
            {
              isAuthenticated() && (
                <Button bsStyle="primary" className="btn-margin" onClick={this.goTo.bind(this, 'about')}>
                  About Us
                </Button>
            ...
            {
              isAuthenticated() && (
                <Button bsStyle="primary" className="btn-margin" onClick={this.goTo.bind(this, 'contact')}>
                  Contact
                </Button>
